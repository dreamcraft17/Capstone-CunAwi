                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="container mt-4">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <label>Date</label>
                                                <input type="date" class="form-control" id="finish_cmt"
                                                    name="finish_cmt" readonly />
                                            </div>
                                            <div class="col">
                                                <label>Day</label>
            ...
            <div class="row">
                <div class="card mt-4">
                    ...
                    <div class="row p-4">
                        ...
                        <input type="hidden" name="draft" id="statusField" value="Draft">

                        <div style="text-align: right;" class="mt-4">
                            <input type="button" id="prevButton" class="previous btn btn-secondary rubik-font"
                                value="Previous" />
                            <input type="submit" id="saveDraftButton" name="draft"
                                class="btn btn-secondary rubik-font" value="Draft" />
                            <input type="submit" id="submitNewProjectButton" name="ongoing"
