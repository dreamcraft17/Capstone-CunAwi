                        ...
                        <div class="row mb-4">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="productID" name="productID" placeholder="Click Here to Enter" value="{{$project->productID}}" />
                                </div>

                                <div class="col">
                                    <label>Toy Name <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="toyName" placeholder="Click Here to Enter" name="toyName" value="{{$project->toyName}}">
                                </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="description" placeholder="Enter Description" name="description" value="{{$project->description}}">
                                </div>

                                <div class="col">
                                    <label>Quantity</label>
                                    <input type="number" class="form-control" name="viewModel.Quota" id="quantity" autocomplete="off" placeholder="Input Toy Quota" value="{{$project->qty}}" />
                                </div>
                            </div>
                            ...
                            <div class="container mt-4">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <label>Date</label>
                                        <input type="date" class="form-control" id="start_date" name="start_date" value="{{$project->start_date}}" readonly />
                                    </div>
                                    <div class="col">
                                        <label>Day</label>
                            ...
                            <div class="container mt-4">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <label>Date</label>
                                        <input type="date" class="form-control" id="finish_cmt" name="finish_cmt" value="{{$project->finish_cmt}}" readonly />
                                    </div>
                                    <div class="col">
                                        <label>Day</label>
                            ...
                            <div class="row mt-4">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="delayreason" placeholder="Enter Remarks" name="delayreason">
                                </div>
                            ...
                            <div class="row mt-4">
                                <label>Remarks</label>
                                <input type="text" class="form-control" id="remarks" placeholder="Enter Remarks" name="remarks" value="{{$project->remarks}}">
                            </div>
                            ...
                            <div style="text-align: right;" class="mt-4">
                                ...
                                <input type="submit" id="" class=" btn btn-primary rubik-font" value="Save" />
                            </div>
