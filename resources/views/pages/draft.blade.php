                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div style="width: 100px; height: 10px; margin-top: 5px; position: relative;">
                                        <div
                                            style="background-color: #4CAF50; height: 100%; width: 100%; border-radius: 3px;">
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div style="width: 100px; height: 10px; margin-top: 5px; position: relative;">
                                        <div
                                            style="background-color: #4CAF50; height: 100%; width: 75%; border-radius: 3px;">
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div style="width: 100px; height: 10px; margin-top: 5px; position: relative;">
                                        <div
                                            style="background-color: #4CAF50; height: 100%; width: 52%; border-radius: 3px;">
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div style="width: 100px; height: 10px; margin-top: 5px; position: relative;">
                                        <div
                                            style="background-color: #4CAF50; height: 100%; width: 0%; border-radius: 3px;">
                                        </div>
                                    </div>
                                </td>
                            </tr>
