                ...
                <div class="col-xl-4 col-lg-5 ml-md-5">
                    <div class="card z-index-0 shadow p-3 mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <button type="submit" name="submit" class="btn btn-primary w-100 my-4 mb-2"
                                    id="login-btn">Register</button>
                                <p class="mt-1 text-secondary" style="font-size: 14px;">Already have an account? <a
                                        href="{{ route('login') }}" class="text-info">Login</a></p>
                            </div>
                            </form>
                        </div>
                    </div>
