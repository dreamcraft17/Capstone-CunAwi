            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="https://en.meming.world/images/en/7/7f/Polish_Jerry.jpg" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                    <div class="nav-wrapper position-relative end-0">
                        <ul class="nav nav-pills nav-fill p-1" role="tablist">
                            <li class="nav-item">
                                <div class="nav-link mb-0 px-0 py-1 d-flex align-items-center justify-content-center " data-bs-toggle="tab" role="tab" aria-selected="false">
                        ...
                        <form id="updateProfileForm" action="{{ route('update_profile') }}" method="post">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="username" name="name" class="form-control" type="text" value="{{ $user->name }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="username2" class="form-control-label">username</label>
                                    <input id="username2" name="name2" class="form-control" type="text" value="{{ $user->username }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="userID" class="form-control-label">User ID</label>
                                    <input id="userID" name="userID" class="form-control" type="text" value="{{ $user->id }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="role" name="role" class="form-control" type="text" value="{{ $user->role }}" readonly>
                                </div>
                            </div>
                            <div style="text-align: right;" class="mt-4">
                                <button id="cancelButton" class="btn btn-secondary btn-sm ms-2" style="display: none;">Cancel</button>
                                <button type="submit" form="updateProfileForm" class="btn btn-primary btn-sm ms-auto">Save</button>
                            </div>
